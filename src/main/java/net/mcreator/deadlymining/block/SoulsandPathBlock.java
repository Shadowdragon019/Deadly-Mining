...
public class SoulsandPathBlock extends DeadlyminingModElements.ModElement {
	@ObjectHolder("deadlymining:soulsand_path")
	public static final Block block = null;
	public SoulsandPathBlock(DeadlyminingModElements instance) {
		super(instance, 20);
	}
