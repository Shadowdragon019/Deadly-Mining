...
public class HeatingEnchantment extends DeadlyminingModElements.ModElement {
	@ObjectHolder("deadlymining:heating")
	public static final Enchantment enchantment = null;
	public HeatingEnchantment(DeadlyminingModElements instance) {
		super(instance, 45);
	}
